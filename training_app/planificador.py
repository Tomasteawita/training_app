        ...
        Returns:
            ...
            
            {
                'ID del período': {
                    'weeks': {
                        'Nombre de la semana': {
                            'Nombre del día': Estado (verdadero o falso),
                            ...
                        },
                        ...
                    },
            ...
            y 'Estado' es verdadero (True) o falso (False) según la disponibilidad de una entrada en la base de datos para ese día en ese período y semana específicos.
        """
        periods_dict = {}
            ...
            for period in periods:
                ...
                for week in Weeks.objects.all():
                    ...
                    for day in Days.objects.all():
                        ...
                        day_dict[day.name] = matching_entry.status if matching_entry else False
                    weeks_dict[week.name] = day_dict

                period_dict['weeks'] = weeks_dict
                periods_dict[str(period.id)] = period_dict
